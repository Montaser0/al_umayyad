import { siteAddressText, siteMapsUrl } from "../../lib/site";
      ...
      <div className="mx-auto max-w-[1280px] px-5 py-16 md:px-10 lg:px-12 lg:py-24">
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm leading-8 text-foreground/55">
            يقع مستشفى الأموي في {siteAddressText}، ضمن ريف حلب الشرقي. يمكنكم
            الوصول إلينا عبر الخريطة أدناه أو فتح الموقع مباشرة في خرائط Google.
          </p>
        </div>

        <div className="overflow-hidden rounded-2xl border border-primary/10 shadow-[0_12px_40px_rgba(28,43,58,0.08)]">
          <iframe
            title="موقع مستشفى الأموي في مدينة بزاعة على الخريطة"
            src={embedSrc}
